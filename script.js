const T = [
  { id: 'qnt', name: 'Quantitative Methods', ico: '≋', col: '#185FA5', bg: '#E6F1FB', sub: '7 LMs', 
    chapters: [
  ...
  { id: 'eco', name: 'Economics', ico: '◎', col: '#3B6D11', bg: '#EAF3DE', sub: '2 LMs', 
    chapters: [
        {id:'e1', name:'LM 1: Currency Exchange Rates: Understanding Equilibrium Value'},
        {id:'e2', name:'LM 2: Economic Growth'}
    ]},
  { id: 'fra', name: 'Financial Statement Analysis', ico: '▦', col: '#533AB7', bg: '#EEEDFE', sub: '6 LMs', 
    chapters: [
  ...
  { id: 'cor', name: 'Corporate Issuers', ico: '◬', col: '#854F0B', bg: '#FAEEDA', sub: '4 LMs', 
    chapters: [
  ...
  { id: 'eqv', name: 'Equity Investments', ico: '↗', col: '#0F6E56', bg: '#E1F5EE', sub: '6 LMs', 
    chapters: [
  ...
  { id: 'fxi', name: 'Fixed Income', ico: '⚓', col: '#185FA5', bg: '#E6F1FB', sub: '5 LMs', 
    chapters: [
  ...
  { id: 'drv', name: 'Derivatives', ico: '∿', col: '#533AB7', bg: '#EEEDFE', sub: '2 LMs', 
    chapters: [
        {id:'dr1', name:'LM 1: Pricing and Valuation of Forward Commitments'},
        {id:'dr2', name:'LM 2: Valuation of Contingent Claims'}
    ]},
  { id: 'alt', name: 'Alternative Investments', ico: '◧', col: '#185FA5', bg: '#E6F1FB', sub: '4 LMs', 
    chapters: [
  ...
  { id: 'pmt', name: 'Portfolio Management', ico: '◈', col: '#0F6E56', bg: '#E1F5EE', sub: '6 LMs', 
    chapters: [
  ...
  { id: 'eth', name: 'Ethics & Professional Standards', ico: '⚖', col: '#854F0B', bg: '#FAEEDA', sub: '3 LMs', 
    chapters: [
  ...
  T.forEach(t => {
    ...
    card.innerHTML = `
      <div style="display:flex; align-items:center; gap:10px; margin-bottom:10px;">
        ...
        <div><div style="font-weight:700; font-size:14px; line-height:1.2;">${t.name}</div><div style="font-size:10px; color:#64748b;">${t.sub}</div></div>
      </div>
...
function openChapterGrid(subjectId) {
  ...
  t.chapters.forEach(ch => {
    const card = document.createElement('div');
    card.className = 'tcard';
    card.innerHTML = `<div style="font-weight:700; font-size:13px;">${ch.name}</div>`;
